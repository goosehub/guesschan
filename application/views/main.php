...
<div class="main_container">
	<header>
		...
		<div class="header_compartment header_center">
			<div class="last_answer_parent">
				<span class="last_answer_status">N/A</span>
				<span class="last_answer_board"></span>
				<a class="last_answer_link" target="_blank" href="#">View on 4chan</a>
			</div>
		</div>
		<div class="header_compartment header_right">
			<div class="score_parent">
				<span class="right_parent"><span class="right_number">0</span></span>
				<span class="wrong_parent"><span class="wrong_number">0</span></span>
				<span class="total_parent"><span class="total_number">0</span></span>
			</div>
		</div>
	</header>
	...
	<div class="how_it_works">
		...
		<p class="quote">>A random post from a random page of a random board is selected. All boards are choosen with equal likelyhood, meaning /b/ is not more likely than /n/. Post number quotes (>>1234) are removed because they are too big a clue. There's no ads or tracking, not even Google Analytics. This was built proudly with PHP using CodeIgniter 3 and the 4chan API. [s4s] is nice board.</p>
	</div>
	<br>
</div>